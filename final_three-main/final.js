...
function init() {
	...
	// loader.setBaseUrl('./models/landscape.obj');
	// loader.setPath('./models/landscape.obj');
	var url = "./models/efha6kh63bla.mtl";
	loader.load( url, 
		function ( materials ) {
			materials.preload();
			...
			objLoader.load( './models/efha6kh63bla.obj', function(obj1){
				object2 = obj1;
			},
			onProgress, onError )
		});
	...
	loader.load( url, 
		function ( materials ) {
			...
			var objLoader = new THREE.OBJLoader( manager );
			objLoader.setMaterials( materials );
			objLoader.load( './models/efha6kh63bla.obj', function(obj2){
				object3 = obj2;
			},
			onProgress, onError )
		});
	loader = new MTLLoader();
	var url = "./models/model.mtl";
	loader.load( url, 
		function ( materials ) {
			materials.preload();
			console.log(materials);
			var objLoader = new THREE.OBJLoader( manager );
			objLoader.setMaterials( materials );
			objLoader.load( './models/model.obj', function(obj3){
				object4 = obj3;
			},
			onProgress, onError )
		});
	...
	loader.load( url, 
		function ( materials ) {
			...
			var objLoader = new THREE.OBJLoader( manager );
			objLoader.setMaterials( materials );
			objLoader.load( './models/boat.obj', function(obj4){
				object5 = obj4;
			},
			onProgress, onError )
		});
